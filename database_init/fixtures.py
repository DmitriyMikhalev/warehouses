...
LOAD_SHOPS_CMDS = """
    INSERT INTO
        shop (address, name, owner_id)
    VALUES
        ('Кирова 79', 'Sparja', 4),
        ('Ленина 17', 'Шестерочка', 4),
        ('Сергинская 104', 'Гошан', 5),
        ('Прямая 2', 'Скотч', 5),
        ('Мира 50', 'Купюра', 5);
"""
...
LOAD_ORDER_CMDS = """
    ...
    VALUES
        (1, 1, '2023-04-16 10:15:00', '2023-04-16 15:20:00'),
        (1, 2, '2023-04-13 16:20:00', '2023-04-13 17:55:00'),
        (2, 3, '2023-04-14 13:00:00', '2023-04-14 14:55:00'),
        (3, 1, '2023-04-13 19:00:00', '2023-04-13 22:30:00'),
        (3, 2, '2023-04-14 03:00:00', '2023-04-14 07:00:00'),
        (4, 3, '2023-04-20 11:00:00', '2023-04-20 12:25:00'),
        (4, 4, '2023-04-18 04:00:00', '2023-04-18 09:45:00'),
        (5, 5, '2023-04-11 12:00:00', '2023-04-11 17:15:00'),
        (5, 4, '2023-05-16 21:00:00', '2023-05-16 23:00:00');
"""

LOAD_PRODUCT_ORDER_CMDS = """
    INSERT INTO
        product_order (
            order_id,
            product_id,
...
LOAD_VHICLE_ORDER_CMDS = """
    INSERT INTO
        vehicle_order (order_id, vehicle_id)
    VALUES
        (1, 1),
        (2, 2),
        (3, 3),
